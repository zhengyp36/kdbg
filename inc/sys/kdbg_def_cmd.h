...
#define KDBG_CMD_DEF_PRIORITY(_prio,_name,_help,_arg0,_arg1,_arg2)	\
...
enum {
	KDBG_CMD_ORDER_HIGH = 0,
	KDBG_CMD_ORDER_NORM = 100,
	KDBG_CMD_ORDER_LOW  = 1000
};

#define KDBG_CMD_DEF_HIGH(_name,_help,_arg0,_arg1,_arg2)		\
	KDBG_CMD_DEF_PRIORITY(KDBG_CMD_ORDER_HIGH,_name,_help,_arg0,_arg1,_arg2)

#define KDBG_CMD_DEF(_name,_help,_arg0,_arg1,_arg2)			\
	KDBG_CMD_DEF_PRIORITY(KDBG_CMD_ORDER_NORM,_name,_help,_arg0,_arg1,_arg2)

#define KDBG_CMD_DEF_LOW(_name,_help,_arg0,_arg1,_arg2)			\
	KDBG_CMD_DEF_PRIORITY(KDBG_CMD_ORDER_LOW,_name,_help,_arg0,_arg1,_arg2)
